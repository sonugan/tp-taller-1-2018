...
enum SPRITE_SHEET {TEAM_A_PLAYER, TEAM_B_PLAYER, SELECTOR_A1, SELECTOR_A2, SELECTOR_A3, SELECTOR_A4, PITCH, BALL, INFO_PANEL_BACK, TEAM_A_MINI_PLAYER, TEAM_B_MINI_PLAYER, MINI_BALL, TEAM_A_KEEPER, TEAM_B_KEEPER, SPLASH, GAME_STATISTICS, GOAL_ZONE};
